...
import com.example.aston_intensiv_4.app1.FragmentA
...
private const val APP_2_COMMIT = "APP_2_COMMIT"
...
class ChoiceFragment : BaseFragment<FragmentChoiceBinding>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.app2Button.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragment_container_view, UserListFragment.newInstance())
                .addToBackStack(APP_2_COMMIT)
                .commit()
        }
    }
}